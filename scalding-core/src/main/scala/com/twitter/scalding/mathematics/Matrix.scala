...
class MatrixMappableExtensions[T](mappable: Mappable[T])(implicit fd: FlowDef, mode: Mode) {
  ...
  def toBlockMatrix[Group, Row, Col, Val](implicit ev: <:<[T, (Group, Row, Col, Val)], grouping: Grouping[(Group, Row)],
    setter: TupleSetter[(Group, Row, Col, Val)]): BlockMatrix[Group, Row, Col, Val] =
    mapToBlockMatrix { _.asInstanceOf[(Group, Row, Col, Val)] }

  def mapToBlockMatrix[Group, Row, Col, Val](fn: (T) => (Group, Row, Col, Val))(implicit grouping: Grouping[(Group, Row)]): BlockMatrix[Group, Row, Col, Val] = {
